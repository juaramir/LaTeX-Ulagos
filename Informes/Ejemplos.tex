...
\begin{demostracion} \label{demo1}
\lipsum[1] %reemplazar esta linea
\end{demostracion}

\begin{observacion}\label{obs1}
\lipsum[1] %reemplazar esta linea
\end{observacion}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.5\linewidth]{images/Reemplazar.png}
...
\begin{subfigure}{0.31\textwidth}\centering
    \includegraphics[width=\textwidth]{images/Reemplazar.png}
...
\begin{wrapfigure}{R}{0.5\textwidth}
  \begin{center}
    \includegraphics[width=8cm]{images/Reemplazar.png}
  \end{center}
