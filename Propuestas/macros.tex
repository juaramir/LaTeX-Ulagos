...
\lstset{%backgroundcolor=\color{lbcolor},
	frame=Ltb, framerule=0pt, aboveskip=0.5cm, tabsize=4, rulecolor=,  basicstyle=\ttfamily\linespread{0.8},inputpath=code,
        ...
        commentstyle= \ttfamily\scriptsize\gris, %comentarios
  morecomment=[l]{//}, % Comentario en línea estilo C++
    ...
    morecomment=[s]{<!}{>}, % Comentario estilo HTML
     ...
     aboveskip=2.8mm,belowskip=-1mm,
        framesep=0pt, rulesep=0.1pt, rulesepcolor=\color{black}, numbers=left, numbersep=4pt, numberstyle=\tiny, numberfirstline = false, breaklines=true,literate={á}{{\'a}}1 {é}{{\'e}}1 {í}{{\'i}}1 {ó}{{\'o}}1 {ú}{{\'u}}1
  ...
  {€}{{\EUR}}1 {£}{{\pounds}}1 {Ñ}{{\~N}}1 {ñ}{{\~n}}1 {¿}{{?`}}1       {\{}{{{\color{delim}{\{}}}}1
