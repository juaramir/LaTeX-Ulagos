...
%%%%%%%%%%%%%%PORTADA
\title[Presentaciones en \LaTeX{}]{\textbf{\huge{Presentaciones en \LaTeX{}}}}
...
\institute[ULagos]{\small{\textbf{Departamento de Ciencias Exactas}\\Ingeniería Civil en Informática}}
\date[\today]{}
%%%%%%%%%%%%%FIN PORTADA

\begin{document}
\setbeamertemplate{background}{\includegraphics[height=10cm,width=16cm]{fondoula}}
