...
%%%%%%%%%%%%%%PORTADA
\title[Introducción a \LaTeX{}]{\textbf{\huge{Introducción a \LaTeX{}}}}
...
\begin{document}
\graphicspath{{images/}}
\setbeamertemplate{background}{\centering\includegraphics[height=10cm,width=16cm]{fondoula}}
...
\begin{itemize}\justifying
  \item \href{https://www.overleaf.com?r=3e23a01e&rm=d&rs=b}{\textbf{Overleaf}}
\end{itemize}
