...
\setbeamertemplate{background}{\centering\includegraphics[height=9cm,width=16cm]{fondoula}}
%%%%%%%%%%%%%%%%%%%%%FIN TEMA

%lstlisting %%%%%CODIGOS
\lstset{tabsize=2,language=tex,basicstyle=\small,keywordstyle=\color{azul}, commentstyle= \scriptsize\color{verde},showstringspaces=false, stringstyle=\color{red},breaklines=true,literate={á}{{\'a}}1 {é}{{\'e}}1 {í}{{\'i}}1 {ó}{{\'o}}1 {ú}{{\'u}}1
...
%%%%%%%%%%%%%%PORTADA
\title[Primer documento en \LaTeX{}]{\textbf{\huge{Primer documento en \LaTeX{}}}}
%\subtitle{Formación General\vspace{-0.3cm}}
\author[Juan José Ramírez Lama]{\small{\textbf{Juan José Ramírez Lama} \\ \texttt{juan.ramirez@ulagos.cl}}}
\institute[ULagos]{\small{\textbf{Departamento de Ciencias Exactas}}}
\date[]{}
%%%%%%%%%%%%%FIN PORTADA

\begin{document}
\setbeamertemplate{background}{\includegraphics[height=10cm,width=16cm]{fondoula}}%4:3
...
\justifying
 \begin{block}{Archivos de Texto Plano}
...
\justifying
 \begin{block}{Formato de los comandos}
\begin{itemize}\justifying
...
\begin{exampleblock}{}
	\verb+\includegraphics[width=6cm]{logoulagos.png}+
\end{exampleblock}
...
\begin{exampleblock}{}
\verb+\begin{center} Texto Centrado \end{center}+\end{exampleblock}
...
\justifying
\begin{block}{}
	Comandos \verb+\chapter{}+, \verb+\section{}+, \verb+\subsection{}+, \verb+\subsubsection{}+, \verb+\paragraph{}+ y \verb+\subparagraph{}+
\end{block}
...
\subsubsection{Subtitulo del subtitulo}
\paragraph{Parrafo}
...
% Contenido
\chapter{Creaci\'on de documentos en \LaTeX{}}
\section{Introducci\'on}
\section{Principios B\'asicos}
...
\justifying
 Comando \verb+\footnote{}+
  ...
  \begin{block}{Ejemplo}
  \begin{lstlisting}
Hola Mundo\footnote{Palabra usada com\'unmente al crear un primer programa o documento}
  \end{lstlisting}
\end{block}
 
 \begin{exampleblock}{Resultado}
Hola Mundo\footnote{Palabra usada comunmente al crear un primer programa o documento}
\end{exampleblock}
\end{frame}
...
\section{Introducci\'on}
Las presentaciones est\'an en UlagosVirtual\footnote{\url{https://www.ulagosvirtual.cl/login/index.php}}.
\end{document}
\end{lstlisting}\vspace{-0.3cm}
\end{block}
...
\begin{block}{Sintaxis}
\verb+\href{http://www.juaramir.com}{Mi P\'agina Personal}+
\end{block}
\begin{exampleblock}{Resultado}
...
\begin{exampleblock}{Ejemplo}
\begin{lstlisting}
\begin{center}\begin{tabular}{|l|p{4cm}|r|} \hline \hlineArt\'iculo & Descripci\'on & Precio\\ \hline \hline23543 & Laptop Sony Vaio VGN-NR21Z & 900 \\ \hline64534 & Mouse inal\'ambrico Dell & 20 \\ \hline\hline \end{tabular}\end{center}
\end{lstlisting}
\end{exampleblock}
...
\begin{minipage}[l]{0.6\linewidth}
   ...
   \vspace{-0.3cm}
\begin{lstlisting}
\includegraphics[width=6cm]{fondoula}
\end{lstlisting}\vspace{-0.3cm}
\end{minipage}\hfill
\begin{minipage}[r]{0.28\linewidth}
\includegraphics[width=3cm]{fondoula}
\end{minipage}
\end{exampleblock}
\end{frame}
...
\item [Letras Griegas]
 ...
 $\rightarrow  \alpha  \beta \gamma \varGamma$
...
\begin{exampleblock}{}
   \vspace{-0.3cm}
\begin{lstlisting}
\begin{displaymath}Z_0 J_n=\frac{\pi \varDelta}{2\sqrt{g_{n-1}\cdot g_n}} \quad \text{para n = 2, 3, \ldots, N} 
\end{displaymath}
\end{lstlisting}\vspace{-0.3cm}
...
\justifying
 \begin{exampleblock}{}
   \vspace{-0.3cm}
\begin{lstlisting}
\begin{displaymath}C_L=\frac{(S_{22}-\varDelta S_{11}^*)^*}{|S_{22}|^2=-|\Delta|^2}\end{displaymath}
...
\begin{block}{}
\begin{displaymath}C_L=\frac{(S_{22}-\varDelta S_{11}^*)^*}{|S_{22}|^2=-|\varDelta|^2}\end{displaymath}\begin{displaymath}R_S=\frac{\sqrt{1-g_s}\cdot (1-|S_{11}|^2)}{1-(1-g_s)\cdot|S_{11}|^2}\end{displaymath}
\end{block}
