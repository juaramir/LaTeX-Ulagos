...
\begin{itemize}
    ...
    \item \textbf{\texttt{Despacho}} (Nueva tabla para absorber la dependencia transitiva):
    \begin{itemize}
        \item \textbf{PK:} \texttt{Profesor\_id}.
        \item \textbf{Atributos no-clave:} \texttt{Despacho}.
    \end{itemize}

    \item \textbf{\texttt{Departamento}} (Tabla original ajustada):
    \begin{itemize}
        \item \textbf{PK:} \texttt{Numero}.
