...
\ifprofesional
\def\subtitulo{Práctica Profesional}
...
\instruccion{Ejemplo: Desarrollar un módulo de facturación electrónica para optimizar los tiempos de emisión de documentos.}

\subsection{Objetivos Específicos del Trabajo}
\moradoc{Ejemplo: Desarrollar un módulo de facturación electrónica para optimizar los tiempos de emisión de documentos.}
\moradoc{\begin{enumerate}\justifying
