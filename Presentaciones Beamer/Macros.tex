...
\usepackage{beamerthemeshadow,beamerthemesplit,cite,cancel,lmodern,eso-pic,fancyvrb,textcomp,times,booktabs,amssymb,amsmath,ragged2e,float,subfig,xspace,epic,eepic,multicol,multirow,colortbl,color,graphicx,url,hyperref,pict2e,array,appendixnumberbeamer,listings,pgfpages,eurosym,wasysym,textcase}
...
\setbeamerfont{title}{shape=\scshape\bfseries,size=\huge}
\setbeamerfont{subtitle}{shape=\scshape}
\setbeamerfont{frametitle}{shape=\scshape\bfseries}
\setbeamerfont{author}{shape=\scshape}
\setbeamerfont{institute}{shape=\scshape\bfseries,size=\small}
...
\setbeamercolor*{palette primary}{use=structure,fg=azul,bg=gray97}%texto titulo y fecha
\setbeamercolor*{palette secondary}{use=structure,fg=azul,bg=gray97}%fondo titulo abajo
...
\AtBeginEnvironment{ejemplo}{%
  \setbeamercolor{block title}{use=structure,fg=negro,bg=verde}
  \setbeamercolor{block body}{use=structure,fg=negro,bg=verde!20!white}
}
...
\lstset{%backgroundcolor=\color{lbcolor},
	frame=Ltb, framerule=0pt, tabsize=4, rulecolor=,  basicstyle=\ttfamily,inputpath=code,
        upquote=true, aboveskip={0.7\baselineskip}, belowskip={-0.5\baselineskip}, columns=fixed, showstringspaces=false, extendedchars=true,breaklines=true, prebreak = \raisebox{0ex}[0ex][0ex]{\ensuremath{\hookleftarrow}}, showtabs=false, showspaces=false, showstringspaces=false,
  ...
  morecomment=[l]{//}, % Comentario en línea estilo C++
    morecomment=[s]{/*}{*/}, % Comentario en bloque estilo C
    morecomment=[l]{--}, % Comentario estilo SQL
    morecomment=[s]{<!}{>}, % Comentario estilo HTML
        stringstyle=\ttfamily\rojo,%cadena de texto
        %numeracion de lineas
        framextopmargin=0.1pt, framexbottommargin=1pt, framexleftmargin=0.1cm,
  ...
  {€}{{\EUR}}1 {£}{{\pounds}}1 {Ñ}{{\~N}}1 {ñ}{{\~n}}1 {¿}{{?`}}1
      ...
      {]}{{{\color{delim}{]}}}}1 {0}{{{\color{numb}0}}}1
      {1}{{{\color{numb}1}}}1
      {2}{{{\color{numb}2}}}1
      {3}{{{\color{numb}3}}}1
      {4}{{{\color{numb}4}}}1
...
\title[\titulo]{{\titulo}}%ajustar posición titulo
\subtitle{{\subtitulo}}
\institute[ULAGOS]{\hspace{5cm}\raggedright{\carrera}\\\hspace{5cm}\raggedright{Departamento de Ciencias de La Ingeniería}}
\date[\today]{}