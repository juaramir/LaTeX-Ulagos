...
\lstset{%backgroundcolor=\color{lbcolor},
	frame=Ltb, framerule=0pt, tabsize=4, rulecolor=,  basicstyle=\ttfamily,inputpath=code,
        upquote=true, aboveskip={0.7\baselineskip}, belowskip={0.1\baselineskip}, columns=fixed, showstringspaces=false, extendedchars=true,breaklines=true, prebreak = \raisebox{0ex}[0ex][0ex]{\ensuremath{\hookleftarrow}}, showtabs=false, showspaces=false, showstringspaces=false,
  ...
  morecomment=[l]{//}, % Comentario en línea estilo C++
    ...
    morecomment=[s]{<!}{>}, % Comentario estilo HTML
        ...
        framextopmargin=3pt, framexbottommargin=3pt, framexleftmargin=0.1cm,
