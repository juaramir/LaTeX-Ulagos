...
En esta parte deben describir el trabajo realizado, desde el inicio hasta el final, incluyendo la descripción de las tablas, figuras, codigos y formulas usadas en el proyecto que se presentan en este informe, tambien si se usan referencias bibliograficas, deben incluirlas en el texto.
