...
\usepackage{cite,cancel,lmodern,fancyvrb,textcomp,times,booktabs,amssymb,amsmath,ragged2e,float,subfig,xspace,epic,eepic,multicol,multirow,colortbl,color,graphicx,url,hyperref,pict2e,array,appendixnumberbeamer,listings,pgfpages,eurosym,wasysym,textcase,datetime,amsthm,amsfonts} % For math fonts, symbols and environments
